 ...
 */
package urstark.solstice.lastfm
...
import urstark.solstice.lastfm.models.LastFmError
import urstark.solstice.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    const val FALLBACK_COMPAT_API_KEY = "solstice"
    const val FALLBACK_COMPAT_SECRET = "solstice"
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "Solstice (https://github.com/SolsticeIO/Solstice)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
