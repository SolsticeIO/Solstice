...
import urstark.solstice.App
import urstark.solstice.BuildConfig
import urstark.solstice.constants.DailyNightlyReleasesEtagKey
import urstark.solstice.constants.DailyNightlyReleasesFingerprintKey
import urstark.solstice.constants.DailyNightlyReleasesJsonKey
import urstark.solstice.constants.DailyNightlyReleasesLastCheckedAtKey
import urstark.solstice.constants.GitHubReleasesEtagKey
import urstark.solstice.constants.GitHubReleasesFingerprintKey
import urstark.solstice.constants.GitHubReleasesJsonKey
import urstark.solstice.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private const val StableReleaseBaseUrl = "https://github.com/SolsticeIO/Solstice/releases"
    private const val DailyNightlyReleaseBaseUrl =
        "https://github.com/SolsticeIO/daily-nightly/releases"
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/SolsticeApp/Solstice/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "Solstice")
    ...
    suspend fun getCommitHistory(
        ...
        runCatching {
            ...
            val response =
                client
                    .get("https://api.github.com/repos/SolsticeApp/Solstice/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestNightlyDownloadUrl(): String {
        ...
        val artifactUrl = "https://nightly.link/SolsticeApp/Solstice/workflows/build/dev/$artifactName"
    ...
    private suspend fun fetchDailyNightlyReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/SolsticeApp/daily-nightly/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "Solstice")
                    if (!cachedEtag.isNullOrBlank()) {
