...
import urstark.solstice.ui.component.LyricsShareImageOptions
import java.io.File
...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: urstark.solstice.ui.component.LyricsGlassStyle? = null,
        shareOptions: LyricsShareImageOptions = LyricsShareImageOptions(),
    ): Bitmap =
        withContext(Dispatchers.Default) {
            val style = glassStyle ?: urstark.solstice.ui.component.LyricsGlassStyle.FrostedDark
    ...
    private fun AppLogo(
        ...
        val rawLogo = context.getDrawable(R.drawable.solar_medal_ribbon)?.toBitmap(logoSize, logoSize)
        val logo =
            rawLogo?.let { source ->
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues =
                ContentValues().apply {
                    ...
                    put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Solstice")
                }
            val uri =
