...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: urstark.solstice.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: urstark.solstice.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: urstark.solstice.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is urstark.solstice.together.JoinDecision -> {
                            ...
                            is urstark.solstice.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
