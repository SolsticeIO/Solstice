            ...
            SettingsGroup(
                ...
                items =
                    listOf(
                        ...
                        SettingsItem(
                            key = "stats",
                            icon = painterResource(R.drawable.solar_history),
                        ...
                        SettingsItem(
                            key = "appearance",
                            icon = painterResource(R.drawable.solar_palette),
                        ...
                        SettingsItem(
                            key = "playback",
                            icon = painterResource(R.drawable.solar_music_note),
                ...
                items =
                    buildList {
                        ...
                        add(
                            SettingsItem(
                                key = "internet",
                                icon = painterResource(R.drawable.solar_wi_fi_router),
                        ...
                        if (isAndroid12OrLater) {
                            add(
                                SettingsItem(
                                    key = "default_links",
                                    icon = painterResource(R.drawable.solar_link),
