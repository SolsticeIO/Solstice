                    ...
                    ListItem(
                        ...
                        leadingContent = {
                            Icon(
                                painter =
                                    painterResource(
                                        if (allInLibrary) R.drawable.solar_clipboard_check else R.drawable.solar_library,
                                    ),
                                contentDescription = null,
                            )
                        },
                        modifier =
                            Modifier.clickable {
                                coroutineScope.launch(Dispatchers.IO) {
                                    ...
                                    val updatedSongs = ArrayList<urstark.solstice.db.entities.SongEntity>()
                    ...
                    ListItem(
                        ...
                        leadingContent = {
                            Icon(
                                painter =
                                    painterResource(
                                        if (allLiked) R.drawable.solar_heart else R.drawable.solar_heart,
                                    ),
                                contentDescription = null,
                            )
                        },
