...
import urstark.solstice.extensions.isSyncEnabled
import urstark.solstice.extensions.isUserLoggedIn
...
import urstark.solstice.ui.component.PlaylistListItem
            ...
            item {
                MenuSurfaceSection(modifier = Modifier.padding(vertical = 6.dp)) {
                    ...
                    ListItem(
                        ...
                        leadingContent = {
                            Icon(
                                painter = painterResource(R.drawable.solar_accessibility),
                                contentDescription = null,
                            )
                        },
                        modifier =
