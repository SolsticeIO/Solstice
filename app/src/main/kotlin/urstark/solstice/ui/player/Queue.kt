...
import urstark.solstice.constants.QueueEditLockKey
import urstark.solstice.db.entities.FormatEntity
import urstark.solstice.db.entities.PlaylistEntity
...
import urstark.solstice.ui.component.MediaMetadataListItem
import urstark.solstice.ui.component.TextFieldDialog
import urstark.solstice.ui.menu.AddToPlaylistDialog
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is urstark.solstice.together.TogetherSessionState.Joined &&
            (togetherSessionState as urstark.solstice.together.TogetherSessionState.Joined).role is urstark.solstice.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? urstark.solstice.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is urstark.solstice.together.TogetherRole.Guest
                                                                if (isGuest) {
    ...
    HorizontalFloatingToolbar(
        ...
        Row(
            ...
            QueueSelectionToolbarAction(
                icon = if (allSelected) R.drawable.solar_text_selection else R.drawable.solar_star_fall,
                contentDescription = null,
            ...
            QueueSelectionToolbarAction(
                icon = R.drawable.solar_playlist_2,
            ...
            QueueSelectionToolbarAction(
                icon = R.drawable.solar_music_library,
            ...
            QueueSelectionToolbarAction(
                icon = R.drawable.solar_trash_bin_trash,
