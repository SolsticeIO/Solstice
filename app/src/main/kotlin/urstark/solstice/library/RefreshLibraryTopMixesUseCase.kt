...
import urstark.solstice.ai.AiTextService
        ...
        private suspend fun requestAiMixes(
            ...
            val response =
                AiTextService.complete(
                    ...
                    systemPrompt =
                        """
                        You are a music curator for Solstice.
...
private fun List<urstark.solstice.innertube.models.Artist>.matchesAnyLocalArtist(song: Song): Boolean {
